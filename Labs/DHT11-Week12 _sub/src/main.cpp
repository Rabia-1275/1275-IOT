...
// // #define BLYNK_TEMPLATE_ID "TMPL6NH14QjBS"
// // #define BLYNK_TEMPLATE_NAME "DHT by Rabia"
// // #define BLYNK_AUTH_TOKEN "zhUg9k7vrJ5Z3e_WtOuKo5ojk89hrht4"
...
// // // ---------- MQTT ----------
// // const char *mqtt_server = "10.13.47.80"; // Mosquitto / Cloud broker
...
// // // ---------- MQTT ----------
// // const char *mqtt_server = "10.13.47.130"; // Mosquitto / Cloud broker
// // const int mqtt_port = 1883;
...
// // ---------- MQTT ----------
// const char *mqtt_server = "10.13.61.17"; // Change to your MQTT broker IP
// const int mqtt_port = 1883;
...
// const char *mqtt_server = "10.13.61.17";
// const int mqtt_port = 1883;
// const char *TOPIC_SUB = "home/#"; // Wildcard to see Lab 1 and Lab 2
...
//   display.print("Topic: ");
//   display.println(topic); // Will show lab1 or lab2
//   display.print("Value: ");
//   display.print(msg);
//   display.println(String(topic).endsWith("temp") ? " C" : " %");
//   display.display();
// }
...
//   while (!mqtt.connected())
//   {
//     if (mqtt.connect("Global_Subscriber"))
//     {
//       mqtt.subscribe(TOPIC_SUB); // Subscribe to wildcard
